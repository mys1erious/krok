...
def writer():
    ...
    while True:
        ...
        print(f'Writing being done by {threading.currentThread().name}.')
...
# There is also an implementations of read priority and write priority
if __name__ == '__main__':
    # read-write equal priority
