"""
Написати Python-застосунок з клієнт-серверною архітектурою,
    який дозволяє клієнтам завантажувати / викачувати файли на / з сервер (а).
Сервер повинен обробляти запити одночасно від декількох клієнтів.
"""
...
def reactor(host, port):
    ...
    sock.bind((host, port))
    sock.listen(5)
    sock.setblocking(False)  # Make async
