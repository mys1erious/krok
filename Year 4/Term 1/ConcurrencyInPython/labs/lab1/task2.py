"""
Написати Python-скрипт, який за допомогою p однотипних потоків
обчислює добуток матриць A (m × n) і B (n × k).
Результат обчислень вивести в стандартний потік виведення.
"""
